...
| reminders          | id                   | bigint                      | NO          | null                                 |
| reminders          | user_id              | uuid                        | NO          | null                                 |
| reminders          | message_id           | bigint                      | YES         | null                                 |
| reminders          | reminder_type        | text                        | NO          | null                                 |
| reminders          | reminder_time        | timestamp without time zone | NO          | null                                 |
| reminders          | is_sent              | boolean                     | YES         | false                                |
| reminders          | created_at           | timestamp without time zone | YES         | now()                                |
